    ...
    ***************************************************************************** */
    ...
    var RolesComponent = /** @class */ (function () {
        ...
        RolesComponent.prototype.getPageInformation = function () {
            var _this = this;
            this.rolesService.getAllPages().subscribe(function (res) {
        ...
        RolesComponent.prototype.updateMenuOrder = function () {
            ...
            this.rolesService.updateMenuOrder({ pages: this.reArrangedList }).subscribe(function (res) {
    ...
    PicsRbacRolesModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: PicsRbacRolesModule, providers: [RbacService, MicrostrategyService, i1$1.HttpClient, HttpService, AlertService, i17.ConfirmationService, PermissionStore, DataStoreService], imports: [[
                i14.CommonModule,
                i1$2.ReactiveFormsModule,
                ngBootstrap.NgbModule,
                i10.TabMenuModule,
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: PicsRbacRolesModule, decorators: [{
                ...
                args: [{
                        ...
                        providers: [RbacService, MicrostrategyService, i1$1.HttpClient, HttpService, AlertService, i17.ConfirmationService, PermissionStore, DataStoreService]
                    }]
            }] });
